    ...
    return (
      <div ref={this.props.setWrapperRef} id="main" style={this.props.timeout ? {display: 'flex'} : {display: 'none'}}>
        ...
        <article id="work" className={`${this.props.article === 'work' ? 'active' : ''} ${this.props.articleTimeout ? 'timeout' : ''}`} style={{display:'none'}}>
          ...
          <p>1.<a href="https://adventure-tracker-frontend.netlify.com/app/"> Google Map API</a><b /> 
          2.<a href="https://adventure-tracker-frontend.netlify.com/billing/"> Stripe API</a><b />
          3.<a href="https://adventure-tracker-frontend.netlify.com"> Facebook OAuth</a></p>
